...
jQuery.luna=function(){
	let luna = '<div class="luna" id="luna_div">'+
...
jQuery.undeveloped=function(){
	let un = "<h3>undeveloped</h3>";
	document.getElementById("undeveloped").innerHTML=un;
}

jQuery.nav=function(){
	let nav = 
		'<nav class="navbar navbar-expand-md navbar-dark nadiv">'+
			'<a class="navbar-brand">Decluna</a>'+
			...
			'<div class="collapse navbar-collapse" id="collapsibleNavbar">'+
				'<ul class="navbar-nav">'+
					'<li class="nav-item ">'+
						'<a class="nav-link cursor_hover"  href="/contents">contents</a>'+
					'</li>'+
					'<li class="nav-item">'+
						'<a class="nav-link cursor_hover" href="/record">record</a>'+
					'</li>'+
					'<li class="nav-item">'+
						'<a class="nav-link cursor_hover" href="/check">check</a>'+
					'</li>'+
					'<li class="nav-item">'+
						'<a class="nav-link cursor_hover" href="/lookup">lookup</a>'+
					'</li>'+
					'<li class="nav-item">'+
						'<a class="nav-link cursor_hover" href="/trick">trick</a>'+
					'</li>'+
					'<li class="nav-item">'+
						'<a class="nav-link cursor_hover" href="/about">about</a>'+
					'</li>'+
				'</ul>'+
			'</div>'+
		'</nav>';
