! function(t) {
		...
		! function() {
			...
			i._$0s = 1, i._$4s = 2, i._$42 = 0, i._$62 = function(t, e) {
				...
				if(i._$AT && !i._$9L) {
					...
					var o = this._$V0;
					o = o * (0 == this._$dP ? 1 : ht._$r2((e - i._$bs) / this._$dP)) * (0 == this._$eo || i._$Do < 0 ? 1 : ht._$r2((i._$Do - e) / this._$eo)), 0 <= o && o <= 1, this.updateParamExe(t, e, o, i), i._$Do > 0 && i._$Do < e && (i._$9L = !0)
				}
			...
			It._$ni = function(t, i, e, r, o, n, s, _, a) {
				...
				if(0 == h) return null;
				var l, $ = ((t - e) * n - (i - r) * o) / h;
				return l = 0 != o ? (t - e - $ * s) / o : (i - r - $ * _) / n, isNaN(l) && (l = (t - e - $ * s) / o, isNaN(l) && (l = (i - r - $ * _) / n), isNaN(l), undefined, undefined), null == a ? new Array(l, $) : (a[0] = l, a[1] = $, a)
			...
			St.prototype._$bT = function() {
				...
				try {
					...
					console.log("err:read utf8 / _$rT _$L0 !! : " + t)
				}
	...
	r.prototype.loadBytes = function(t, i) {
		...
		let url;
		//jave model
		if(t.indexOf(".mtn") != -1 || t.indexOf(".moc") != -1|| t.indexOf(".json") != -1)
			url = "/elf/down?path=/static/framework/decluna/luna" + path;
		else
			url = t;
		...
		//java texture
		e = "/elf/down?path=/static/framework/decluna/luna" + e.split("..")[1];
		var n = new Image;
	...
	o.prototype = new n.L2DBaseModel, o.prototype.load = function(t, i, e) {
		...
		else if(!this.mainMotionManager.reserveMotion(e)) return void(h.default.DEBUG_LOG);
		var o, n = this;
		...
		if(r.setFadeIn(this.modelSetting.getMotionFadeIn(t, i)), r.setFadeOut(this.modelSetting.getMotionFadeOut(t, i)), h.default.DEBUG_LOG, null == this.modelSetting.getMotionSound(t, i)) this.mainMotionManager.startMotionPrio(r, e);
		else {
