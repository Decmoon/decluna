$(function() {
	...
	function init() {
		$(".sky-container").attr("style", "z-index: -1;")
		...
		farStars = createStars(1200, 370, "#A5BFF0"); //lightBlue
		nearStars = createStars(1200, 290, "#118CD6"); //lightBlue
	...
	function render() {
		...
		if(intersects.length > 0) {
			(function() {
				...
				intersects[0].face.color.setStyle(feadColor);
				plane.geometry.colorsNeedUpdate = true;
			})();
		}
	...
	$('.shift-camera-button').click(function() {
		...
		$(".sky-container").attr("style", "z-index: 1;")
		$("#holder canvas").addClass("cursor_hover")
